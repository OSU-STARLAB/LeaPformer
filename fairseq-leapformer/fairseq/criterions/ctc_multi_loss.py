...
class CTCMultiLoss(FairseqCriterion):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--ctc-encoder-layer', default=1, type=int, metavar='LAYER_NUM',
    ...
    def build_criterion(cls, args, task):
        ...
        class CTCEncoderWrapperModel(BaseFairseqModel):
            def __init__(self, args, ctc_dictionary):
                ...
                self.ctc_encoder_layer = getattr(args, "ctc_encoder_layer", 1)
            ...
            def forward(self, model, src_tokens, src_lengths, prev_output_tokens, **kwargs):
                ...
                encoder_out = model.encoder(src_tokens, src_lengths=src_lengths, return_all_hiddens=True)
